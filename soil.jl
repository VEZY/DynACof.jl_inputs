...
Wm1             = 210.0,    # Minimum water content of the first layer (mm)
Wm2             = 58.0,     # Minimum water content of the second layer (mm)
Wm3             = 64.0,     # Minimum water content of the third layer (mm)
Wf1             = 290.0,    # Field capacity of the first layer (mm)
Wf2             = 66.0,     # Field capacity of the second layer (mm)
Wf3             = 69.0,     # Field capacity of the third layer (mm)
EWMtot          = 93.0,     # = (Wf1-Wm1)+(Wf2-Wm2)+(Wf3-Wm3) (mm)
IntercSlope     = 0.2,      # Rainfall interception coefficient (mm LAI-1)
WSurfResMax     = 120.0,    # Maximum soil water level at the surface reservoir. Above this value excess rainfall runs-off inmediately (mm)
